...
export default function ClassroomFilter({ closeForm }) {
  ...
  const submit = (e) => {
    e.preventDefault()
    form.get(route('classroom.index', team_slug), {
      preserveScroll: true,
    })
  }
...
const FilterBox = ({ title, children }) => {
  return (
    <div className="p-4 space-y-2 text-gray-700 rounded-md shadow-md bg-yellow-50 dark:bg-gray-700 dark:text-white">
