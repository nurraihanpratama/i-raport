...
import ClassroomDataTable from './Components/DataTable/ClassroomDataTable'
...
export default function Index() {
  ...
  function onClickNew() {
    ...
    const url = route('classroom.create', auth.user.role)
  ...
  return (
    <ThemeLayout title={title}>
      ...
      <ClassroomDataTable collection={collection} onClickNew={onClickNew} withNewButton />
