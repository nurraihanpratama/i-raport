  ...
  if (visible)
    return (
      <div
        ...
        className={`absolutes w-full flex-center flex-col lg:flex-row space-y-8 gap-20 rounded-xl h-full modal-overlay ${className}`}
        style={{ zIndex: 999999 }}
      >
        {/* Pakai animasi */}
        {/* <div className="loader"></div> */}
        <div className="gap-2 text-gray-700 flex-center dark:text-white whitespace-nowrap">
